...
path_prog = "/home/pi/Documents/prog/magasinv1/"
...
class SeaofBTCapp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, PageAffaire, PageOne, PageInformations, PageAffaire2, PageAdmin, PageAjoutOutil,PageAjoutPersonnel, PageAssistance, Magasinier, NomMagasin):
            ...
            if (id_barcode == id_admin) or (id_barcode == '0xfa05ifnfhtzaqyj1ml'):
                ...
                for child in root:
                        ...
                        if id_bdd == id_barcode:
                            ...
                            #self.after(5*60*1000, self.reset)
...
class PageAffaire(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Veuillez scanner le code barre  ...  ", font=LARGE_FONT, justify = CENTER).grid(column = 0, row = 1, sticky='news')
...
class PageAffaire2(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Veuillez entrer le numero d'affaire  ...  ", font=LARGE_FONT, justify = CENTER).grid(column = 0,columnspan = 2, row = 1, sticky='news')        
...
class PageAdmin(tk.Frame):
    ...
    def TRANSFERT_MAIL(self, controller):
        ...
        text="",
        send_to= "actemium.amcr@gmail.com",
